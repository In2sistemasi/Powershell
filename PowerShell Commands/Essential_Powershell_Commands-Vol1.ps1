...
# To dismiss a process you can use the process ID or the process name. 
# The -processname switch allows the use of wildcards. Here's how to stop the calculator:
